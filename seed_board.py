...
CARDS = [
    ...
    # In Review
    ("In Review", "Add social feed for following friends", "Bob", "2026-04-24T23:59:00.000Z",
    ...
    ("In Review", "Implement heart rate zone calculations", "Alice", "2026-04-25T23:59:00.000Z",
    ...
    ("In Review", "Write unit tests for workout logging API", "Dave", "2026-04-24T23:59:00.000Z",
    ...
    # In Progress
    ("In Progress", "Add calorie tracking to workout logs", "Alice", "2026-04-28T23:59:00.000Z",
    ...
    ("In Progress", "Fix push notification delay after workout ends", "Dave", "2026-04-28T23:59:00.000Z",
    ...
    ("In Progress", "Add GPS route tracking to outdoor runs", "Carol", "2026-04-29T23:59:00.000Z",
    ...
    ("In Progress", "Build weekly summary dashboard", "Bob", "2026-04-28T23:59:00.000Z",
    ...
    ("In Progress", "Integrate Apple HealthKit sync", "Carol", "2026-04-30T23:59:00.000Z",
    ...
    # Backlog — first two are duplicate-detection demo targets
    ...
    ("Backlog", "Implement personal bests leaderboard", "Alice", "2026-04-28T23:59:00.000Z",
    ...
    ("Backlog", "Update goal milestone thresholds", "Alice", "2026-04-28T23:59:00.000Z",
